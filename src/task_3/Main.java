...
public class Main {
    ...
    public static void main(String[] args) {
        for (int i = 0; i < 500; i++) {
            ...
            PriorityQueue<Integer> lazyQueue1 = new PriorityQueueLinkedListLazy<>();
        ...
        for (int i = 1000; i <= 6000; i += 1000) {
            ...
            PriorityQueue<Integer> lazyQueue = new PriorityQueueLinkedListLazy<>();
...
//            lazyTimes.add((double) (endLazy - startLazy) / 1000000);
            ...
            System.out.println("Время ленивого списка: " + lazyTimes.get(lazyTimes.size() - 1) + " мс");
            System.out.println();
        }
    }
}
